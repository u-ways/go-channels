...
var DentistIsReady = 		Green + "%s's Assistant signaled patients are ready to be treated" + Reset
...
var MovedAllLowPriorityPatients = Cyan + "%s no longer has low priority patients to move to high priority." + Reset
...
var PlacedAllPatientInTheWaitingArea = Cyan + "%s placed ALL patients in the waiting area" + Reset